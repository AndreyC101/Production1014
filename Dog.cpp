...
{
	TheTextureManager::Instance()->load("../Assets/textures/DogBig.png", "dog", TheGame::Instance()->getRenderer());
	setPosition(m_Patrol[0]);
	setCollisionRadius(10);
	glm::vec2 size = TheTextureManager::Instance()->getTextureSize("dog");
	setWidth(size.x);
	setHeight(size.y);
...
void Dog::draw()
{
	...
	TheTextureManager::Instance()->modifiedDraw("dog", xComponent, yComponent, 6, imageOffset, TheGame::Instance()->getRenderer(), m_currentHeading, 255, true);
}
